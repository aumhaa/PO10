...
var conformedPaths = {absolute:{rootPath:'', appPath:'', userPath:'', logPath:'', packagePath:'', amxdPath:'', localFolderPath:'', livePath:''},
						boot:{rootPath:'', appPath:'', userPath:'', logPath:'', packagePath:'', amxdPath:'', localFolderPath:'', livePath:''}};
...
function nodeLog()
{
	...
	if((args[0] == 'npm')&&(args[1] == 'success')&&(statusDict.get('args')[1] == 'install')&&(statusDict.get('status') == 'completed'))
	{
